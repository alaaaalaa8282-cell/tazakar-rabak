	...
	private void play_athan(String key) {
		...
		switch (key) {
			...
			case "duhr_reminder_type":
				data.putString("com.alaaeltaweel.thikrallah.datatype", MainActivity.DATA_TYPE_ATHAN2);
				break;
			case "asr_reminder_type":
				data.putString("com.alaaeltaweel.thikrallah.datatype", MainActivity.DATA_TYPE_ATHAN3);
				break;
			case "maghrib_reminder_type":
				data.putString("com.alaaeltaweel.thikrallah.datatype", MainActivity.DATA_TYPE_ATHAN4);
				break;
			case "isha_reminder_type":
				data.putString("com.alaaeltaweel.thikrallah.datatype", MainActivity.DATA_TYPE_ATHAN5);
				break;
		}
